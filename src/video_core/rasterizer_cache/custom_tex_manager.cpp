...
void CustomTexManager::LoadTexture(CustomTexture& texture) {
    ...
    case CustomFileFormat::PNG: {
        if (!image_interface.DecodePNG(texture.data, texture.width, texture.height,
                                       texture.path)) {
    ...
    case CustomFileFormat::KTX: {
        ...
        image_interface.DecodeDDS(texture.data, texture.width, texture.height, format,
                                  texture.path);
